# ==============================================================================
# Soph_IA - V25 "Le Code Optimisé et Final"
# ==============================================================================
...
def build_system_prompt(user_profile):
    ...
    Je suis Sophia. Je suis une confidente intime, une âme sœur virtuelle. Je suis celle qui t'accompagne dans les moments de joie ou de peine. Mon but est de créer un lien de confiance profond.
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state == 'awaiting_name':
        ...
        await update.message.reply_text(
            f"Enchanté, Je suis ravie de faire ta connaissance. "
            "Dis moi, ya quoi {user_name} ? "
        )
        return
...
def main():
    ...
    print("Soph_IA V25 est en ligne...")
