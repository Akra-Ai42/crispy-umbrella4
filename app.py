...
# ==============================================================================
# Soph_IA - V63 "Le Code Final et Fonctionnel" (CORRECTION DU BUG DE TYPE)
# ==============================================================================
...
logger = logging.getLogger("sophia.v63")
...
def build_adaptive_system_prompt(user_profile, emotional_summary):
    ...
    # --- CORRECTION CRITIQUE ICI : Garantir que les variables sont des chaînes (str) ---
    env_info = user_profile.get("geo_info") or "Non précisé"
    pro_info = user_profile.get("pro_info") or "Non précisé"
    socle_info = user_profile.get("socle_info") or "Non précisé" # FIX: Évite l'erreur 'NoneType' object has no attribute 'lower'
...
def main():
    ...
    logger.info("Soph_IA V60 starting...")
